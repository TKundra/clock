...
/// Full weekday name for an index produced by [`day_of_week`].
///     0 = Sunday
///     1 = Monday
///     ...
///     6 = Saturday
///
/// Out-of-range values fall back to `"?"` rather than panicking,
/// since we have no unwinding machinery in a `no_std` kernel.
...
///     12 = December
///
/// The RTC stores months as 1..=12, matching [`DateTime::month`].
